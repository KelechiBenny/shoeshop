...
<!--Less styles -->
   <!-- Other Less css file //different less files has different color scheam
	<link rel="stylesheet/less" type="text/css" href="assets/less/simplex.less">
	<link rel="stylesheet/less" type="text/css" href="assets/less/classified.less">
	<link rel="stylesheet/less" type="text/css" href="assets/less/amelia.less">  MOVE DOWN TO activate
	-->
	<!--<link rel="stylesheet/less" type="text/css" href="assets/less/bootshop.less">
	<script src="assets/js/less.js" type="text/javascript"></script> -->
	
<!-- Bootstrap style --> 
    <link id="callCss" rel="stylesheet" href="assets/bootshop/bootstrap.min.css" media="screen"/>
