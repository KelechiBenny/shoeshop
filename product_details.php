...
<a id="smallScreen" data-target="#topMenu" data-toggle="collapse" class="btn btn-navbar">
  ...
  <div class="navbar-inner">
    <a class="brand" href="index.html"><img src="assets/images/logo.png" alt="Bootsshop"/></a>
		<form class="form-inline navbar-search" method="post" action="product_details.php" >
...
<!-- Sidebar end=============================================== -->
    ...
    <li><a href="#Main">Products</a> <span class="divider">/</span></li>
    <li class="active">product Details</li>
    </ul>	
	<div class="row">	  
				<?php
				$shoes = new Controllers\shoesControllers;
				$shoes->viewShoeDetails($id);
				?>
